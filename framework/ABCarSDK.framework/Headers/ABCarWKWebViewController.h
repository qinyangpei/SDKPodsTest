...
typedef enum WebViewStatusBarStyle{
    StatusBarStyle_DarkContent = 0,    //默认使用黑色字体
    StatusBarStyle_LightContent = 1    //白色字体
}WebViewStatusBarStyle;
...
/** 状态栏样式，默认为白色字体 */
@property (nonatomic, assign) WebViewStatusBarStyle stautsBarStyle;
